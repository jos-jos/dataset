...
DATA_PATH = {
    'gossipcop_fake_dataset': './dataset/gossipcop_fake.csv',
    'gossipcop_real_dataset': './dataset/gossipcop_real.csv',
    'politifact_fake_dataset': './dataset/politifact_fake.csv',
    'politifact_real_dataset': './dataset/politifact_real.csv'
...
def get_dataset_info(dataset='politifact'):
    true, fake = __get_directories(dataset_name=dataset)
